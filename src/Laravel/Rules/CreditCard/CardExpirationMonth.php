...
class CardExpirationMonth extends AbstractRule implements Rule
{
    public const MSG_CARD_EXPIRATION_MONTH_INVALID = 'validation.credit_card.card_expiration_month_invalid';
