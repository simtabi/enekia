...
class CardExpirationDate extends AbstractRule implements Rule
{
    public const MSG_CARD_EXPIRATION_DATE_FORMAT_INVALID = 'validation.credit_card.card_expiration_date_format_invalid';
    public const MSG_CARD_EXPIRATION_DATE_INVALID        = 'validation.credit_card.card_expiration_date_invalid';
