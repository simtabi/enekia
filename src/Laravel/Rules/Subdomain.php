...
class Subdomain extends AbstractRule implements Rule
{
     ...
     * @return self
     */
    public function setReserved(array $reserved): self
    {
    ...
    public function getReserved(): array
    {
        ...
        return !empty($this->reserved) ? array_merge($this->reserved, $reserved) : $reserved;
    }
    ...
    public function passes($attribute, $value)
    {
        ...
        if (in_array($value, $this->getReserved())) {
            return false;
        }
