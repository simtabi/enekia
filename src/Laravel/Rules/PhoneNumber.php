...
class PhoneNumber extends AbstractRule implements Rule
{
    ...
    private bool $e164   = false;
    private bool $nanp   = false;

    public function byDigits()
    {
        $this->digits = true;
    }

    public function byE123()
    {
        $this->e123 = true;
    }

    public function byE164()
    {
        $this->e164 = true;
    }

    public function byNANP()
    {
        $this->nanp = true;
    }
    ...
    public function passes($attribute, $value): bool
    {
        ...
        if ($this->digits){
            $this->messageKey = 'digits';
            return $this->isDigits($value);
        }elseif ($this->e123){
            $this->messageKey = 'e123';
            return $this->isE123($value);
        }elseif ($this->e164) {
            $this->messageKey = 'e164';
