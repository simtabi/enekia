...
trait IsinNumber
{
     ...
     * @var bool
     */
    protected bool $checkIsinNumber = false;

    public function checkIsinNumber(): static
    {
        $this->checkIsinNumber = true;

        return $this;
    }

    public function validateIsinNumber($attribute, $value): bool
    {
        return (new Luhn())->isValid($this->normalize($value));
    }
