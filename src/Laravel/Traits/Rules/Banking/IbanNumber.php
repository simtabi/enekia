...
trait IbanNumber
{
     ...
     * @var bool
     */
    protected bool $checkIBANNumber = false;

    public function checkIBANNumber(): static
    {
        $this->checkIBANNumber = true;
     ...
     * @return bool
     */
    public function validateIBANNumber($attribute, $value): bool
    {
        // normalize value
