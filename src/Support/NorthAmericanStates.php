...
namespace Simtabi\Enekia\Support;
...
class NorthAmericanStates
{
    ...
    {
        $this->iso2CountryCode = strtoupper($iso2CountryCode);
    ...
    {
        return match ($this->iso2CountryCode) {
            "US", "MX" => "State",
            "CA"       => "Province",
    ...
    public function getStateAbbreviations()
    {
        ...
        foreach ($this->statesByCountry as $c => $states) {
            if ($this->iso2CountryCode === null || $c === $this->iso2CountryCode) {
